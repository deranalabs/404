  ...
  return (
    <section id="hub" className="px-6 md:px-8 py-16 md:py-20 max-w-7xl mx-auto">
      <div className="mb-10 md:mb-12">
        ...
        <p className="text-3xl md:text-4xl font-black italic tracking-tighter text-light uppercase">Current Operations</p>
      </div>
      ...
      <div className="p-6 md:p-8 border border-white/5 bg-white/[0.02] rounded-sm">
